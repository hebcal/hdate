...
func TestHebrew2RD(t *testing.T) {
	assert := assert.New(t)
	assert.Equal(int64(733359), hdate.HebrewToRD(5769, hdate.Cheshvan, 15))
	assert.Equal(int64(711262), hdate.HebrewToRD(5708, hdate.Iyyar, 6))
	assert.Equal(int64(249), hdate.HebrewToRD(3762, hdate.Tishrei, 1))
	assert.Equal(int64(72), hdate.HebrewToRD(3761, hdate.Nisan, 1))
	assert.Equal(int64(1), hdate.HebrewToRD(3761, hdate.Tevet, 18))
	assert.Equal(int64(0), hdate.HebrewToRD(3761, hdate.Tevet, 17))
	assert.Equal(int64(-1), hdate.HebrewToRD(3761, hdate.Tevet, 16))
	assert.Equal(int64(-16), hdate.HebrewToRD(3761, hdate.Tevet, 1))
	assert.Equal(int64(2278650), hdate.HebrewToRD(9999, hdate.Elul, 29))
	assert.Equal(int64(731840), hdate.HebrewToRD(5765, hdate.Tishrei, 1))
	assert.Equal(int64(731957), hdate.HebrewToRD(5765, hdate.Shvat, 1))
	assert.Equal(int64(731987), hdate.HebrewToRD(5765, hdate.Adar1, 1))
	assert.Equal(int64(732017), hdate.HebrewToRD(5765, hdate.Adar2, 1))
	assert.Equal(int64(732038), hdate.HebrewToRD(5765, hdate.Adar2, 22))
	assert.Equal(int64(732046), hdate.HebrewToRD(5765, hdate.Nisan, 1))
}
